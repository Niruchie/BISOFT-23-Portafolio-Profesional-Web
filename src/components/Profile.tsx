...
export default function Profile() {
	...
	return (
		<Container fluid id='Profile' className='m-0 p-0 g-0' style={{ minHeight: height }}>
			<Container fluid ref={refProfile} className='py-5'>
				...
				<Row className='text-center'>
					<p><Trans i18nKey='description1' ns='Profile' lang={lang} /></p>
					<p><Trans i18nKey='description2' ns='Profile' lang={lang} /></p>
				</Row>
				...
				<Row>
					<Container fluid className='d-flex justify-content-end mx-0 my-4 p-0'>
						<div
							data-aos='fade-up'
							className='text-truncate text-white text-end w-75 p-5'
							style={{ backgroundColor: 'var(--color-secondary)', borderRadius: '1rem 0 0 1rem' }}>
							<p className='h1'>
					...
					<Container fluid className='d-flex justify-content-start mx-0 my-4 p-0'>
						<div
							data-aos='fade-up'
							className='text-wrap text-white text-start w-75 p-5'
							style={{ backgroundColor: 'var(--color-tertiary)', borderRadius: '0 1rem 1rem 0' }}>
							<p className='h1'>
					...
					<Container fluid className='d-flex justify-content-end mx-0 my-4 p-0'>
						<div
							data-aos='fade-up'
							className='text-wrap text-white text-end w-75 p-5'
							style={{ backgroundColor: 'var(--color-primary)', borderRadius: '1rem 0 0 1rem' }}>
							<p className='h1'>
					...
					<Container fluid className='d-flex justify-content-start mx-0 my-4 p-0'>
						<div
							data-aos='fade-up'
							className='text-wrap text-white text-start w-75 p-5'
							style={{ backgroundColor: 'var(--color-secondary)', borderRadius: '0 1rem 1rem 0' }}>
							<p className='h1'>
							...
							<p className='w-100 text-start mt-5'>
								<Button as='a' href='https://drive.google.com/file/d/1mu9YuIQFZn-1OBGNm9ztK99J4UolVeY0/view?usp=sharing'
									target='_blank' rel='noreferrer' className={['text-white', 'px-4', 'py-2'].join(' ')}
										style={{ backgroundColor: 'var(--color-tertiary)', borderRadius: '0.5rem' }}
